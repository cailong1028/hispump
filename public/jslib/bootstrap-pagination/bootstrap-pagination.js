...
;(function(root, factory) {
    ...
    var BootstrapPagination = function(element, options) {
    ...
    BootstrapPagination.prototype = {
        constructor: BootstrapPagination,
        destroy: function() {
            this.$element.empty();
        ...
        buildItem: function(type, page) {
            ...
            // 澶勭悊backbone鐨勭洃鍚紝fuck锛屾妸鑷繁鍧戜簡銆傘€�
                itemContent = $('<a></a>'),
            // 銆傘€傘€�
                itemText = null;
        ...
        setupEvents: function() {
            ...
            this.$listContainer.find('li').each(function() {
                ...
                $this.click(function(evt) {
                    ...
                    base.options.bypass && evt.preventDefault();
    ...
    $.fn.pagination = function(option) {
        ...
        if (!data) $this.data('twbs-pagination', (data = new BootstrapPagination(this, options)));
    ...
    $.fn.pagination.defaults = {
        ...
        bypass: true // 鏄惁璺宠繃backbone鐨勪簨浠剁洃鍚�
    };
    $.fn.pagination.Constructor = BootstrapPagination;
